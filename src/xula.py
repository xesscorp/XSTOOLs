...
class Xula:
    ...
    def reset(self):
        ...
        xsusb.reset()
        # Sleep for a bit while the board re-initializes.
        time.sleep(4)
    ...
    def update_firmware(self, hexfile):
        ...
        self.xsusb.set_reflash_mode()
        self.xsusb.reset()
        self.micro.program_flash(hexfile)
        self.xsusb.set_user_mode()
        self.xsusb.reset()
...
class Xula50(Xula):
    """Class object for a XuLA board with an XC3S50A FPGA."""
    def __init__(self, xsusb_id=0):
...
class Xula200(Xula):
    """Class object for a XuLA board with an XC3S200A FPGA."""
    def __init__(self, xsusb_id=0):
        Xula.__init__(self,xsusb_id)
